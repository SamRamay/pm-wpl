...
@section('content')
      ...
      <div class="col-md-9 float-left">
        ...
        <form action="{{ route('companies.update',[$company->id]) }}" method="post">
            ...
            <div class="form-group">
                <input type="submit" class="btn btn-outline-warning" style="margin-bottom: 10px;" value="Submit">
            </div>        
...
<div class="col-sm-3 col-md-3 float-right">
          ...
          <div class="sidebar-module" style="padding: 15px;">
            ...
            <ol class="list-unstyled">
              <li><a href="/companies/{{ $company->id }}"><i class="fas fa-hand-point-left  "></i> Curent Company</a></li>
              <hr>
